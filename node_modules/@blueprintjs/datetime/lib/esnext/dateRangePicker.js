...
export class DateRangePicker extends AbstractPureComponent {
    ...
    maybeRenderShortcuts() {
        ...
        return [
            React.createElement(Shortcuts, Object.assign({ key: "shortcuts" }, { allowSingleDayRange, maxDate, minDate, shortcuts, timePrecision }, { onShortcutClick: this.handleShortcutClick })),
