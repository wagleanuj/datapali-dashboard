...
var DateRangePicker = /** @class */ (function (_super) {
    ...
    DateRangePicker.prototype.maybeRenderShortcuts = function () {
        ...
        return [
            React.createElement(Shortcuts, tslib_1.__assign({ key: "shortcuts" }, { allowSingleDayRange: allowSingleDayRange, maxDate: maxDate, minDate: minDate, shortcuts: shortcuts, timePrecision: timePrecision }, { onShortcutClick: this.handleShortcutClick })),
