...
export class MenuItem extends React.PureComponent {
    render() {
        const { active, className, children, disabled, icon, intent, labelElement, multiline, popoverProps, shouldDismissPopover, text, textClassName, tagName = "a", ...htmlProps } = this.props;
