...
const { ApolloServer, ApolloError, AuthenticationError } = require('apollo-server-express');
...
const auth = process.env.DB_PASS ? { user: process.env.DB_USER, password: process.env.DB_PASS } : null;
